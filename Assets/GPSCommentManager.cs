...
//this class controls the comment loading and display for the GPS AR stuff.
//see the CommentManager class for the comments, as this class is just a copy-paste of that class with minor changes
public class GPSCommentManager : MonoBehaviour {
    ...
    void Start() {
        //this gets the location from the gpsCounter class
        locationName = gpsCounter.locationName;
        header.text = gpsCounter.locationName;

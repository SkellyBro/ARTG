...
//this class handles the object raycast
public class ObjectRaycastHandler : MonoBehaviour {
    ...
    public string descriptionScene = "objectDescriptionScene";
    public static string objTagName;
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit, 1000.0f))
            {
                 ...
                 */
                if (hit.collider.gameObject.tag == "ObjectPref" && EventSystem.current.IsPointerOverGameObject(Input.GetTouch(0).fingerId)==false)

                {
                    objTagName = "ObjectPref";
